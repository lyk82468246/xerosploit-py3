...
def main():
	...
	print("\033[1;34m\n[++] Please choose your operating system.\nPlease make sure your work path is */xerosploit-py3.\033[1;m")
...
""")
	...
	if system0 == "1":
		...
		install = os.system("apt-get update && apt-get install -y nmap hping3 build-essential python3-pip ruby-dev git libpcap-dev libpcap0.8-dev libgmp3-dev && pip install tabulate terminaltables")
